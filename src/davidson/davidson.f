      SUBROUTINE jdqz( alpha, beta, eivec, wanted, n, shift, eps, 
     &     kmax, jmax, jmin, method, m, l, maxnmv, maxstep,
     &     lock, order, testspace, work, lwork )
...
c===========================================================================
      ...
      DOUBLE COMPLEX shift, alpha( * ), beta( * )
      DOUBLE COMPLEX work( n, * ), eivec( n, * )
...
c     PARAMETER ( ldvs= 50, ldzwork = 4*ldvs )
     ...
     $     zwork( 4 * ldvs ), aconv( ldvs ), bconv( ldvs )
      ...
      DOUBLE COMPLEX mqkz( ldqkz, ldqkz ), invqkz( ldqkz, ldqkz )
      DOUBLE COMPLEX f( ldqkz )

      INTEGER i, j, k, info, mxmv, step
      INTEGER d, u, v, w, aux, av, bv, q, z, kz, itmp, tp
      INTEGER solvestep

      DOUBLE PRECISION rnrm, rwork( 3 * ldvs ), deps, dtmp
...
c     changed by S. Birner to allow more than 50 eigenvalues
     ...
     &     CALL error( 'jdqz: jmax greater than MAX( 3 * kmax, 20 )' )
...
c     loop
 ...
 100  CONTINUE
      ...
      IF ( MOD( step, 100 ) .EQ. 0.0 ) PRINT*, "step =",
     &     step, "found =", k
...
c...........................................................................
               ...
               mxmv = 1
	       CALL zgmres( n, work( 1, v + j ), work( 1, d ),
...
c...........................................................................
               ...
               CALL zcgstabl( n, work( 1, v + j ), work( 1, d ),
...
c---------------------------------------------------------------------------
 	    ...
 	    CALL jdqzmv( n, work( 1, v + j - 1 ), work( 1, w + j - 1 ),
